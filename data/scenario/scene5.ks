...
[bg  time="1000"  method="crossfade"  storage="adultward.png"  ]
[chara_show  name="DrLilyTang"  time="1000"  wait="true"  left="413"  top="140"  width=""  height=""  reflect="false"  ]
[tb_show_message_window  ]
[font  size="20"  color="0xffffff"  italic="true"  ]
[tb_start_text mode=1 ]
It is now May 2003, and two months have passed since the outbreak of SARS in HK. [p]
While you work in the A&E most of the time, [p]
you have also volunteered to work in the SARS wards due to the shortage of doctors there. [p]
However, there is a glimmer of hope as the number of new cases and deaths from SARS is showing a downward trend. [p]
Nevertheless, you have lost 8kg under the immense stress and pressure. [p]
Over these last two months, you have watched the horror of SARS spread and strike down countless civilians and medical personnel, [p]
and you understand the risk of your job. [p]
You are prepared for death, but you are not afraid.[p]
You are working in the SARS wards tonight with another doctor.[p]
[_tb_end_text]

[chara_show  name="Doctor"  time="1000"  wait="true"  left="-24"  top="133"  width="275"  height="361"  reflect="false"  ]
[resetfont  ]
[tb_start_text mode=1 ]
# You
I think we’re almost finished with the rounds tonight...[p]
One more patient, let us check on Mr. Chen and see how he is doing.[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
who was admitted last week into the SARS ward, has stopped breathing.[p]
You snap into action and, together with your colleague, you try to resuscitate Mr. Leung. [p]
Sadly, despite your attempts, you are unable to revive him...[p]
[_tb_end_text]

[chara_mod  name="MrLeung"  time="600"  cross="false"  storage="chara/8/mr_leung_black_n_white.png"  ]
[tb_start_text mode=1 ]
# You
Another patient has gone...[p]
Every day I am working very hard, but nothing has improved...[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#
As Mr. Leung is taken away, [p]
[_tb_end_text]

[chara_hide  name="MrLeung"  time="1000"  wait="true"  pos_mode="false"  ]
[tb_start_text mode=1 ]
you feel a great sense of letdown as another SARS patient has passed away. [p]
You continue monitoring the patients in the SARS ward until morning when you begin to feel feverish. [p]
With a sense of foreboding, you understand you likely contracted SARS from the resuscitation attempt last night, [p]
and you check yourself into the hospital. [p]
The doctor with you the previous night has also developed similar symptoms.[p]
[_tb_end_text]
